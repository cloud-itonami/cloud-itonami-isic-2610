...
`cloud-itonami-2610` accepts contributions to the OSS blueprint, capability
...
```bash
kbb -X:test   # in the referenced kotoba-lang libs
kbb -M:lint
```

## Rules
- Do not commit real operating, personal or credential data.
- Keep robot dispatch, records and disclosures behind the Fab Operations Governor.
