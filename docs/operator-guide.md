...
- human sign-off for :high/:safety-critical robot actions (e.g. handling wafers, chemicals and expensive/in-critical-supply lots)
...
## Operating states
spec : design : verify : package : manufacture : audit
