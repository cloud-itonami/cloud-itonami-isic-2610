# Operator Quickstart — Semiconductor and Electronics Manufacturing Enablement

Shortest path from clone to a verified local dry-run for **ISIC 2610** (`cloud-itonami-isic-2610`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2610.git
cd cloud-itonami-isic-2610
```
...
- Blueprint governor key: `fab-operations-governor`
- Likely source path: `fab.governor.cljc`
